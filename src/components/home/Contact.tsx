          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {contacts.map((contact) => (
              <a
                ...
                className="glass-surface2 p-4 rounded-lg flex flex-col items-center justify-center space-y-2 hover:bg-surface transition-all duration-300 group"
              >
                <div className="text-muted group-hover:text-highlight transition-colors">
                  {contact.icon}
                </div>
                <span className="text-sm text-muted group-hover:text-highlight transition-colors">
                  {contact.label}
                </span>
              </a>
            ))}
